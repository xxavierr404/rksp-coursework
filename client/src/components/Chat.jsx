...
const Chat = () => {
    ...
    const updateManagerRights = async () => {
        await axios.get(
            `http://${process.env.REACT_APP_SERVER_IP}:5553/api/v1/chat/${id}/${userId}/check-rights`,
            {
                headers: {
    ...
    const getChatInfo = async () => {
        ...
        await axios.get(
            `http://${process.env.REACT_APP_SERVER_IP}:5553/api/v1/chat/${id}`,
            {
                headers: {
                    Authorization: `Bearer ${Cookies.get("workus-tkn")}`
                }
        ...
        await axios.get(
            `http://${process.env.REACT_APP_SERVER_IP}:5555/api/v1/messages/history/${id}`,
            {
                headers: {
                    Authorization: `Bearer ${Cookies.get("workus-tkn")}`
                }
    ...
    const updatePotentialMembers = async () => {
        axios.get(
            `http://${process.env.REACT_APP_SERVER_IP}:5553/api/v1/chat/${id}/potential-members`,
            {
                headers: {
                    Authorization: `Bearer ${Cookies.get("workus-tkn")}`
                }
