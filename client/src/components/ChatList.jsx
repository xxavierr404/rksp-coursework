...
const ChatList = (props) => {
    ...
    const updateChatList = async () => {
        axios.get(
            `http://${process.env.REACT_APP_SERVER_IP}:5553/api/v1/chats`,
            {
                headers: {
    ...
    const updatePotentialChatList = async () => {
        axios.get(
            `http://${process.env.REACT_APP_SERVER_IP}:5553/api/v1/chats/available`,
            {
                headers: {
                    Authorization: `Bearer ${Cookies.get("workus-tkn")}`
                }
    ...
    const createChat = async () => {
        axios.post(
            `http://${process.env.REACT_APP_SERVER_IP}:5553/api/v1/chat`,
            {
                name: newChatName,
